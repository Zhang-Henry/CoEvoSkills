...
The `most_loaded_branches` array must contain exactly the 10 in-service branches with a positive `rateA` limit that have the highest `loading_pct`, ordered from highest to lowest loading.
